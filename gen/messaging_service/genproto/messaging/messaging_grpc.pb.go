...
const (
	...
	MessagingService_SubscribeToNotifications_FullMethodName = "/messaging.MessagingService/SubscribeToNotifications"
)
...
type MessagingServiceClient interface {
	...
	SubscribeToNotifications(ctx context.Context, in *SubscribeToNotificationsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[NotificationStream], error)
}
...
func (c *messagingServiceClient) SubscribeToNotifications(ctx context.Context, in *SubscribeToNotificationsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[NotificationStream], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &MessagingService_ServiceDesc.Streams[0], MessagingService_SubscribeToNotifications_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToNotificationsRequest, NotificationStream]{ClientStream: stream}
...
type MessagingService_SubscribeToNotificationsClient = grpc.ServerStreamingClient[NotificationStream]
...
type MessagingServiceServer interface {
	...
	SubscribeToNotifications(*SubscribeToNotificationsRequest, grpc.ServerStreamingServer[NotificationStream]) error
...
func (UnimplementedMessagingServiceServer) SubscribeToNotifications(*SubscribeToNotificationsRequest, grpc.ServerStreamingServer[NotificationStream]) error {
...
func _MessagingService_SubscribeToNotifications_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeToNotificationsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(MessagingServiceServer).SubscribeToNotifications(m, &grpc.GenericServerStream[SubscribeToNotificationsRequest, NotificationStream]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MessagingService_SubscribeToNotificationsServer = grpc.ServerStreamingServer[NotificationStream]
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _MessagingService_SubscribeToNotifications_Handler,
			ServerStreams: true,
		},
	},
